/**
  * FeatherCandleTrinket_standalone.ino
  *
  * @file     FeatherCandleTrinket_standalone.ino
  ...
  *           with an Adafrtuit Trinket M0.
  *           This code can be run without the Feather HUZZAH connected to the Trinket.
  *           Connect an ON/OFF pushbutton to Pin 1 of the Trinket using a pull-down resistor.
  *           (pushbutton is active high)
